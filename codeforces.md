...
|6|X|459B|Find min and max value, afterwards go through array and count min and max values. Output the difference as well as the amount of the combination. If the min and max value are the same, the amount of combinations is [n * (n - 1) / 2].|[Code](problems/codeforces/1300/459B.cpp)|[CF-URL](https://codeforces.com/problemset/problem/459/B)|
